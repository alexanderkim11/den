...
pub fn new_account(_handle: tauri::AppHandle, network : String) -> (bool,(String, String, String)){
    if network == "Mainnet".to_string(){
        ...
        match native_privatekey_result {
            ...
            Err(_) => {
                return (true,("Error: Could not generate private key".to_string(), String::new(), String::new()));
            }
        }
        ...
        match native_viewkey_result {
            ...
            Err(_) => {
                return (true,("Error: Could not derive view key from private key".to_string(), String::new(), String::new()));
            }
        }
        ...
        match native_address_result {
            ...
            Err(_) => {
                return (true,("Error: Could not derive address from private key".to_string(), String::new(), String::new()));
            }
        }

        return (false,(native_privatekey.to_string(), native_viewkey.to_string(), native_address.to_string()));
        ...
        return (true, ("Error: undefined behavior".to_string(), String::new(), String::new()));
    }
}

#[tauri::command]
pub fn account_from_pk(_handle: tauri::AppHandle, network : String, privatekey : String) -> (bool,(String, String, String)){
    if network == "Mainnet".to_string(){
        pub use snarkvm_console::network::MainnetV0 as CurrentNetwork;
        ...
        match native_privatekey_result {
            ...
            Err(_) => {
                return (true,("Error: Could not parse private key".to_string(), String::new(), String::new()));
            }
        }
...
#[tauri::command]
pub fn sign(_handle: tauri::AppHandle, network : String, privatekey: String, message : String) -> (bool, String){
    if network == "Mainnet".to_string(){
        pub use snarkvm_console::network::MainnetV0 as CurrentNetwork;
        ...
        let native_signature_result = SignatureNative::sign_bytes(&native_privatekey, message_bytes, &mut StdRng::from_entropy());
...
#[tauri::command]
pub fn verify(_handle: tauri::AppHandle, network : String, address: String, message : String, signature : String) -> (bool,String){
